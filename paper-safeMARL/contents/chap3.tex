...
上述可达性分析与状态估计模块共同遵循双离线预计算范式：前者基于环境数据学习安全裕度分布，后者基于交互数据建模感知噪声特性。两者均可在离线阶段完成训练与构建，在部署时无需在线更新，从而显著降低计算开销，提高方法在资源受限平台上的可落地性。
...
本章围绕安全强化学习在机器人导航避障问题，构建了CMPL框架，即“安全可达空间刻画 + 策略生成 + 安全过滤 + 状态估计”的完整执行链路。
