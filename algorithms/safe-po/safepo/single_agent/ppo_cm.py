...
from safepo.common.single_cm_constraint import SingleNavAtacomV2
...
def main(args, cfg_env=None):
    ...
    Nav_cm = SingleNavAtacomV2(base_env=env, timestep=0.002)
    Nav_cm.reset()
    ...
    for epoch in range(epochs):
                    ...
                    if done or time_out:
                        ...
                        logger.store(
                            **{
                                ...
                                "action_adjustment":p/ep_len[idx],
                            }
                        )
                        ep_ret[idx] = 0.0
                        ep_cost[idx] = 0.0
        ...
        if not logger.logged:
            ...
            logger.log_tabular("Goal_achieved_rate",goal_achieved/episode_cnt)
            logger.log_tabular("action_adjustment")
            if args.use_eval:
